...
\begin{frame}[fragile]{Test}
  ...
  \begin{lstlisting}[style=hask]
    ...
    zipWith :: (a -> b -> c) -> @vc[@a@vc]@ -> @vc[@b@vc]@ -> @vc[@c@vc]@ @|\pause@
    zipWith _ @vc[]@     _      = @vc[]@ @|\pause@
    zipWith _ _      @vc[]@     = @vc[]@ @|\pause@
    zipWith f (x@vc:@xs) (y@vc:@ys) = f x y @vc:@ zipWith f xs ys
  \end{lstlisting}
  ...
  \begin{lstlisting}[style=hask]
    {-# LANGUAGE KitchenSink #-}
    zipWith :: (a -> b -> c) -> @vc[@a@vc]@ -> @vc[@b@vc]@ -> @vc[@c@vc]@
    zipWith f (x@vc:@xs) (y@vc:@ys) = f x y @vc:@ zipWith f xs ys
    zipWith _ _      _      = @vc[]@
  \end{lstlisting}
\end{frame}
