...
\begin{frame}[fragile]{Maybe}
  ...
  \begin{lstlisting}[style=hask]
    ...
    barbara = (@vcPerson@ "Barbara" "Smith" @vc30,@ Just "dancer")
...
\begin{frame}[fragile]{Other Kinds}
  ...
  All these \hkind{Kinds} are built-in and inferred as of GHC 7.10.2. In next release or so, the \hsort{Sort} \hsort{BOX} will likely go away.
\end{frame}
